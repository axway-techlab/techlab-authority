...
- The [API Manager instance](https://ptx148.demo.axway.com:8075/) for this use case.
- 👟 This repository's [actions](http://github.com/jcabrera-axway/techlab-authority/actions)
- Agents 
  - 🟢 [Start](https://ptx148.demo.axway.com:8081/agent/both/start)
  - 🔴 [Stop](https://ptx148.demo.axway.com:8081/agent/both/stop)
  - ❓ [Status](https://ptx148.demo.axway.com:8081/agent/both/status)
...
These services get information about patients and their health-related data.

Your clients are hospitals, biological laboratories and lone physicians that use your services to make appointments, get access to healt data in a secure way and in compliance with the applicable regulations.

This Gateway is more directly targeted at the <u>**partners**</u> of your clients, the first of which being HealthTrack:

### The app

**HealtTrack**

HealthTrack gathers information several services including yours to give its end-users a consistent
view of every data related to their health and their relative's (children, elder parents, etc).
HealthTrack requires its end users an annual fee, and pays your clients for access to the data they store.
